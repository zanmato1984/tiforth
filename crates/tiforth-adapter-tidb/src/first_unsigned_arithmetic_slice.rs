...
pub struct TidbFirstUnsignedArithmeticSliceAdapter;

impl TidbFirstUnsignedArithmeticSliceAdapter {
...
mod tests {
    ...
    fn canonical_requests_cover_all_documented_cases() {
        let requests = TidbFirstUnsignedArithmeticSliceAdapter::canonical_requests();
    ...
    fn execute_rows_normalizes_schema_and_row_count() {
        let request = TidbFirstUnsignedArithmeticSliceAdapter::canonical_requests()
            .into_iter()
        ...
        let result = TidbFirstUnsignedArithmeticSliceAdapter::execute(&request, &runner).unwrap();
    ...
    fn lowering_rejects_requests_with_mismatched_operation_refs() {
        let mut request = TidbFirstUnsignedArithmeticSliceAdapter::canonical_requests()
            .into_iter()
        ...
        let error = TidbFirstUnsignedArithmeticSliceAdapter::lower_request(&request).unwrap_err();
