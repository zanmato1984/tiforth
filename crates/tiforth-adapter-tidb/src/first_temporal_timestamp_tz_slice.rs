...
pub struct TidbFirstTemporalTimestampTzSliceAdapter;

impl TidbFirstTemporalTimestampTzSliceAdapter {
...
mod tests {
    ...
    fn lowering_renders_ordering_sql_for_ordering_ref_case() {
        let request = TidbFirstTemporalTimestampTzSliceAdapter::canonical_requests()
            .into_iter()
            .find(|request| request.case_id == "timestamp-tz-order-asc-nulls-last")
            .unwrap();

        let plan = TidbFirstTemporalTimestampTzSliceAdapter::lower_request(&request).unwrap();
    ...
    fn execute_normalizes_temporal_error_classes() {
        let type_request = TidbFirstTemporalTimestampTzSliceAdapter::canonical_requests()
            .into_iter()
            .find(|request| {
        ...
        let unit_request = TidbFirstTemporalTimestampTzSliceAdapter::canonical_requests()
            .into_iter()
    ...
    fn lowering_rejects_requests_with_mismatched_ordering_ref() {
        let mut request = TidbFirstTemporalTimestampTzSliceAdapter::canonical_requests()
            .into_iter()
            .find(|request| request.case_id == "timestamp-tz-order-asc-nulls-last")
            .unwrap();
        ...
        let error = TidbFirstTemporalTimestampTzSliceAdapter::lower_request(&request).unwrap_err();
