...
pub struct TiflashFirstSignedWideningAddInt64SliceAdapter;

impl TiflashFirstSignedWideningAddInt64SliceAdapter {
...
mod tests {
    ...
    fn canonical_requests_cover_all_documented_cases() {
        let requests = TiflashFirstSignedWideningAddInt64SliceAdapter::canonical_requests();
    ...
    fn execute_rows_normalizes_schema_and_row_count() {
        let request = TiflashFirstSignedWideningAddInt64SliceAdapter::canonical_requests()
            .into_iter()
        ...
        let result =
            TiflashFirstSignedWideningAddInt64SliceAdapter::execute(&request, &runner).unwrap();
    ...
    fn lowering_rejects_requests_with_mismatched_projection_refs() {
        let mut request = TiflashFirstSignedWideningAddInt64SliceAdapter::canonical_requests()
            .into_iter()
        ...
        let error =
            TiflashFirstSignedWideningAddInt64SliceAdapter::lower_request(&request).unwrap_err();
