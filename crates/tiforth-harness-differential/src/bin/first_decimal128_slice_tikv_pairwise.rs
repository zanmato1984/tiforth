...
use tiforth_harness_differential::first_decimal128_slice_tikv_pairwise::{
    execute_first_decimal128_slice_tikv_pairwise, render_drift_report_artifact_json,
...
impl tidb::TidbRunner for FixtureTidbRunner {
    fn run(
        ...
        match plan.request.case_id.as_str() {
            ...
            "decimal128-missing-column-error" => Err(tidb::EngineExecutionError::EngineFailure {
                code: Some("1054".to_string()),
                message: "Unknown column '__missing_column_1' in 'where clause'".to_string(),
            }),
            "unsupported-decimal-type-error" => Err(tidb::EngineExecutionError::EngineFailure {
                code: Some("1105".to_string()),
                message:
                    "unsupported decimal type: decimal256 input is out of scope for first-decimal128-slice"
                        .to_string(),
            }),
            "invalid-decimal-metadata-error" => Err(tidb::EngineExecutionError::EngineFailure {
                code: Some("1105".to_string()),
...
impl tikv::TikvRunner for FixtureTikvRunner {
    fn run(
        ...
        match plan.request.case_id.as_str() {
            ...
            "unsupported-decimal-type-error" => Err(tikv::EngineExecutionError::EngineFailure {
                code: Some("1105".to_string()),
                message:
                    "unsupported decimal type: decimal256 input is out of scope for first-decimal128-slice"
                        .to_string(),
            }),
            "invalid-decimal-metadata-error" => Err(tikv::EngineExecutionError::EngineFailure {
                code: Some("1105".to_string()),
                message: "invalid decimal metadata: decimal(10,12) has scale greater than precision"
                    .to_string(),
            }),
