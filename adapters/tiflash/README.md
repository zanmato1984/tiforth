...
- `inventory/first-expression-slice-tiflash-compat-notes.md` and `inventory/first-filter-is-not-null-slice-tiflash-compat-notes.md` now capture TiFlash-side compatibility notes for both current differential slices
