...
- `inventory/first-expression-slice-tidb-compat-notes.md` and `inventory/first-filter-is-not-null-slice-tidb-compat-notes.md` now capture TiDB-side compatibility notes for both current differential slices
