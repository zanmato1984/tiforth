...
- the first timezone-aware timestamp checkpoint now has docs-first semantic, conformance, differential, and adapter anchors through `docs/design/first-temporal-timestamp-tz-slice.md`, `tests/conformance/first-temporal-timestamp-tz-slice.md`, `tests/differential/first-temporal-timestamp-tz-slice.md`, and `adapters/first-temporal-timestamp-tz-slice.md`
