...
- the first nested struct handoff checkpoint now has docs-first semantic, conformance, differential, and adapter anchors through `docs/design/first-struct-aware-handoff-slice.md`, `tests/conformance/first-struct-slice.md`, `tests/differential/first-struct-slice.md`, and `adapters/first-struct-slice.md`, plus local executable shared-kernel conformance coverage in `crates/tiforth-kernel/tests/struct_slice.rs`
- the first nested map handoff checkpoint now has docs-first semantic, conformance, differential, and adapter anchors through `docs/design/first-map-aware-handoff-slice.md`, `tests/conformance/first-map-slice.md`, `tests/differential/first-map-slice.md`, and `adapters/first-map-slice.md`, plus local executable shared-kernel conformance coverage in `crates/tiforth-kernel/tests/map_slice.rs`
- the first nested union handoff checkpoint now has docs-first semantic, conformance, differential, and adapter anchors through `docs/design/first-union-aware-handoff-slice.md`, `tests/conformance/first-union-slice.md`, `tests/differential/first-union-slice.md`, and `adapters/first-union-slice.md`, plus local executable shared-kernel conformance coverage in `crates/tiforth-kernel/tests/union_slice.rs`
