...
- the next checkpoint is to execute `first-map-slice` differential adapter and harness coverage so the documented `case_id`, `input_ref`, and artifact carriers land as checked-in inventory evidence
