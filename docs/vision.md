...
- the first checked-in per-engine compatibility notes now cover first-expression, first-filter, and first-temporal-date32 for TiDB, TiFlash, and TiKV, plus first-decimal128 and first-float64-ordering for TiDB and TiFlash under `inventory/`
