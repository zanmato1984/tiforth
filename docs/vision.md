...
- the docs-first temporal date32 checkpoint now has conformance, differential slice, and adapter boundary anchors through `docs/design/first-temporal-semantic-slice.md`, `tests/conformance/first-temporal-date32-slice.md`, `tests/differential/first-temporal-date32-slice.md`, and `adapters/first-temporal-date32-slice.md`
