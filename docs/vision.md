...
- the first float64 NaN/infinity ordering checkpoint now has docs-first semantic, conformance, differential, and adapter anchors through `docs/design/first-float64-ordering-slice.md`, `tests/conformance/first-float64-ordering-slice.md`, `tests/differential/first-float64-ordering-slice.md`, and `adapters/first-float64-ordering-slice.md`
