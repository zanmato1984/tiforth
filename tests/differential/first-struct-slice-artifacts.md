...
Issue #331 is docs-first only and does not add or refresh those `inventory/`
files.
...
- `Inventory-Impact: none - struct artifact carriers documented but no executable artifact refresh performed`
...
- executable struct adapter or differential harness wiring
