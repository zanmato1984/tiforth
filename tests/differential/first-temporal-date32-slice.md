...
Status: issue #176 design checkpoint, issue #185 artifact-carrier checkpoint, issue #187 harness checkpoint, issue #264 TiKV boundary checkpoint, issue #266 TiKV single-engine checkpoint, issue #270 TiKV pairwise checkpoint
...
The TiKV request and response boundary plus single-engine and pairwise checkpoints for this same slice are defined in `adapters/first-temporal-date32-slice-tikv.md`.
...
in `adapters/first-temporal-date32-slice.md`, and the TiKV single-engine plus pairwise checkpoints for the same slice are anchored in `adapters/first-temporal-date32-slice-tikv.md`.
...
- live TiKV runner wiring and inventory refresh workflow for this slice
